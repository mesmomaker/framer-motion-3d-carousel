...
const Track = ({
  ...
  const lengthItems = Math.round(state.items.length / 2);

  //let middleItemCalc = state.middle;
  // info.middle = [lengthItems];

  // console.log(info.middle)

  // return (item[middleItemNumber] === item * -1 + trackDimensions.x ?? 0);
